# basically the PolynomialMutation (from pymoo.operators.mutation.pm import PolynomialMutation), 
# but with a additional sort function
...
from pymoo_implementation.population.population_sorting import sort_pop
...
class PolynomialMutationMLP_Optimization(Mutation):
